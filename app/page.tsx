...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col gap-8 items-center p-24 bg-gradient-to-b from-gray-100 to-gray-300 dark:from-gray-900 dark:to-gray-700">
      ...
      <ul className="text-center w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        {data?.map((user) => {
          return (
            <li key={user.id} className="flex items-center border-b border-gray-300 dark:border-gray-700 py-4 px-4 justify-between gap-2 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
              <div className="flex-1">
                <span className="text-gray-900 dark:text-gray-100 font-bold">{user.name}</span>
                <span className="text-gray-600 dark:text-gray-400 block">{user.email}</span>
              </div>
              <div className="flex gap-2">
                <button onClick={() => setEditUser(user)} className="bg-green-500 text-white p-2">Edit</button>
